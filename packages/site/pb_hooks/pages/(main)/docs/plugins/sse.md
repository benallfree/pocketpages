...
The Realtime plugin (`pocketpages-plugin-realtime`) adds Server-Sent Events (SSE) support to PocketPages, enabling real-time updates and notifications in your application.
