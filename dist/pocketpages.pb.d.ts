...
type PagesResponse = {
    ...
    cookie: <T>(name: string, value: T, options?: Partial<SerializeOptions$1>) => void;
};
...
export { AfterBootstrapHandler, type AuthData, type AuthOptions, type Cache, type CreateUserOptions, type FilterOptions, MiddlewareHandler, type MiddlewareLoaderFunc, type OAuth2ProviderInfo, type OAuth2RequestOptions, type OAuth2SignInOptions, type PageDataLoaderFunc, type PagesConfig, type PagesGlobalContext, type PagesInitializerFunc, type PagesMethods, type PagesMiddlewareFunc, type PagesNextFunc, type PagesParams, type PagesRequest, type PagesRequestContext, type PagesResponse, type RedirectOptions, type ResolveOptions, type User, findRecordByFilter, findRecordsByFilter, globalApi, log$1 as log, moduleExists, stringify, v23MiddlewareWrapper };
